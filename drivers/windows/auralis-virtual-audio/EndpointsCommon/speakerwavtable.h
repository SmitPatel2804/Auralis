...
// Keep the inherited pin numbering used by SysVAD, but make the offload pin
// impossible to instantiate. Every render stream must pass through the system
// ring that Auralis copies to the loopback pin.
